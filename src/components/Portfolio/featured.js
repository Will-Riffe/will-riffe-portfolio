...
function Featured(props) {
  return (
    <div className="general smallScroll">
      <ProjectView
        ...
        technologies={["React,", "Apollo for GraphQL,", "Material-UI,", "React Router,", "jwt-decode,", "Node.js,", "MongoDB with Mongoose,", "Express.js,", "JSON Web Tokens"]}
      />
      ...
      <ProjectView
        ...
        technologies={["Node.js,", "Express.js,", "Axios,","Mustache/Handlebars,", "MySQL2,", "Sequelize ORM,", "Nest.js,", "bcrypt,", "Third-Party API: TheMealdb"]}
      ...
      <ProjectView
        ...
        githubLink={"https://github.com/Will-Riffe/Project-1-Event-Scout"}
        description={
        ...
        technologies={["HTML,", "CSS,", "JavaScript,", "Materialize,", "JQuery,", "Node.js,", "Third-Party API's: Ticketmaster, Google Maps"]}
